...
namespace MathQuiz
{
    public partial class Form1 : Form
    {
        ...
        public void StartTheQuiz() // nabella
        {
        ...
        private void startButton_Click(object sender, EventArgs e) //farhan
        {
            StartTheQuiz();
            startButton.Enabled = false;
        }

        private void timer1_Tick(object sender, EventArgs e)//unik
        {
            if (CheckTheAnswer())
            {
                timer1.Stop();
